...
//		Page page = new Page();
//		page.setPage(1);
		List<DevCameraEvent> list = devCameraEventService.queryAll();
		DevCameraEvent queryDevCameraById = devCameraEventService.queryDevCameraById("3014-290026");
		
		System.out.println(list);
		System.out.println(queryDevCameraById);
