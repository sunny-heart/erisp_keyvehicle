app.factory("warningMapService",["$http","$q",function($http,$q) {
	...
	// GET查询预警车辆信息
	function queryWarningVehicleInfo(params,success,error) {
		var dataUrl = "/erisp-keyvehicle/service/vehicleInfo/queryWarningVehicleInfo";
		$http({
			url : dataUrl,
			method : "GET",
			params : params
    ...
    return {
    	...
    	queryWarningVehicleInfo:queryWarningVehicleInfo,
