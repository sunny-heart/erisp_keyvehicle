 ...
 * 事故信息查询
 */
app.controller('illegalManageController', ['$scope','$state','$timeout','$modal', '$log','$filter','illegalManageService','SweetAlert',
  function($scope, $state, $timeout, $modal, $log,$filter,illegalManageService,SweetAlert) {
  ...
  //查询
    ...
    $scope.queryFunction = function () {
    	...
    	illegalManageService.searchIllegalInfo($scope.queryConditionData,function (data) {
    	    if (data.state == 200) {
