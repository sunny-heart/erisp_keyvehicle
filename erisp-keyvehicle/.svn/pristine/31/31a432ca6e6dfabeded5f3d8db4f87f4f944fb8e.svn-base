package com.gkhb.keyvehicle.common;
...
import com.gkhb.keyvehicle.common.utils.PropertiesUtils;
...
public class Constants {
     ...
     * 系统配置文件中的行政区域
     */
    public static final String SYSTEM_AREACODE = "areaCode";
     ...
     * 疲劳驾驶时间阀值（小时）
     */
    public static int FATIGUE_DRIVING = 4;
    /**
     * 物流车行驶限速（KM/H）
     */
    public static int LOGISTICS_VEHICLE_SPEED = 60;
	 ...
	 * GPS数据服务器地址
	 */
	public static String DATASERVICE_HOST_PATH = null;
    ...
    static{
		...
		FATIGUE_DRIVING = Integer.parseInt(String.valueOf(properties.get("fatigueDriving")));
		LOGISTICS_VEHICLE_SPEED = Integer.parseInt(String.valueOf(properties.get("logisticsVehicleSpeed")));
		DATASERVICE_HOST_PATH = String.valueOf(properties.get("dataservice.host.path"));
	...
	public static void main(String[] args) {
		...
		System.out.println(Constants.FATIGUE_DRIVING);
	}
    
	/**
	 * sms用户名
	 */
	public static final String SMS_USER = "eddywon";
	
	/**
	 * sms短信发送密钥
	 */
	public static final String SMS_KEY = "6f88ffbe51b6a6f9a141";
