app.factory("taxiMapService",["$http","$q",function($http,$q) {
	...
	// 根据车辆类型查询车辆信息
	function queryVehicleInfoByVehicleType(vehicleType,departName,plateNumber,onlineState,isRegisterArea,ascriptionCompany,success,error) {
	...
	// GET查询所有车辆信息
	function queryTaxiInfo(params,success,error) {
        var dataUrl = "/erisp-keyvehicle/service/taxiInfo/queryTaxiInfo";
        $http({
            url : dataUrl,
            method : "GET",
            params : params
	...
	function queryVehicleDriveInfo(params,success,error) {
        var dataUrl = "/erisp-keyvehicle/service/taxiInfo/queryTaxiDriveInfo";
        $http({
            url : dataUrl,
            method : "GET",
            params : {plateNumber:params}
	...
	//查询所属企业
	function queryAscriptionCompany(params,success,error) {
        var dataUrl = "/erisp-keyvehicle/service/ascriptionCompany/queryAscriptionCompany";
        $http({
            url : dataUrl,
            method : "GET",
            params : params
    ...
    return {
    	...
    	queryAscriptionCompany:queryAscriptionCompany
    }
}
])