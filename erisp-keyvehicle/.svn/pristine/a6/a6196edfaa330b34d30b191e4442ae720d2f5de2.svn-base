...
//      'mainCss': 'vendor/3.17/esri/css/main.css',
      ...
      'mapInit': 'vendor/3.17/init.js',
        'mapDraw' : ['vendor/3.17/esri/toolbars/_toolbar.js', 'vendor/3.17/esri/toolbars/draw.js'],
        ...
        //预警处置
        'warningMapController': 'assets/js/controllers/warningDisposal/warningMapController.js',
        'warningMapService': 'assets/js/controllers/warningDisposal/warningMapService.js',
        'focusMapController': 'assets/js/controllers/warningDisposal/focusMapController.js',
        'focusMapService': 'assets/js/controllers/warningDisposal/focusMapService.js',
        ...
        //预警处置窗口
        'warningDisposalWindowCtrl': 'assets/js/controllers/warningDisposal/warningDisposalWindowCtrl.js',
        //预警设置
        ...
        'warningCopyService':'assets/js/controllers/warningDisposal/warningCopyService.js',
        ...
        //处置录入
        'disposalEntryController': 'assets/js/controllers/warningDisposal/disposalEntryController.js',
        
        //图片更新
        'dealPhotoController': 'assets/js/controllers/photo/dealPhotoController.js',
        'dealPhotoService': 'assets/js/controllers/photo/dealPhotoService.js',
        
        //***********************预警规则********************************//
        'warningRuleController': 'assets/js/controllers/warningRule/warningRuleController.js',
        ...
        'reportsBySubofficesController': 'assets/js/controllers/reports/reportsBySubofficesController.js',
        'reportsByCompaniesController': 'assets/js/controllers/reports/reportsByCompaniesController.js',
        ...
        'realLineMapCtrl': 'assets/js/controllers/map/realLineMapCtrl.js',
        'hisLineMapCtrl': 'assets/js/controllers/map/hisLineMapCtrl.js',
        'busMapCtrl': 'assets/js/controllers/map/bus/busMapCtrl.js',
        'busMapService': 'assets/js/controllers/map/bus/busMapService.js',
        'taxiMapCtrl': 'assets/js/controllers/map/taxi/taxiMapCtrl.js',
        'taxiMapService': 'assets/js/controllers/map/taxi/taxiMapService.js',
        //轨迹追踪
