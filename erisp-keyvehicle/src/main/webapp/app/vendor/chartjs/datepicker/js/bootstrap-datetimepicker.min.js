		...
		(function(f, c) {
			...
			var i = function(l, k) {
				...
				this.fontAwesome = k.fontAwesome
						|| this.element.data("font-awesome") || true
			...
			var g = {
				...
				headTemplate : '<thead><tr><th class="prev"><i class="{iconType} {leftArrow}"/></th><th colspan="5" style="width:145px;"></th><th class="next"><i class="{iconType} {rightArrow}"/></th></tr></thead>',
