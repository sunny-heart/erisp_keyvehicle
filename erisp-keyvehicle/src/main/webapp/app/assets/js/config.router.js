...
//***********************预警处置********************************//
    ...
    .state('app.warningDisposal.focusMap', {
    	...
    	resolve: loadSequence('mapInit','mainCss','focusMapService','mapService','taxiMapService','focusMapController')
    })
    //实时处置
    ...
    //根据分局统计报表
    .state('app.reports.countBySuboffices', {
    	url: '/countBySuboffices',
    	templateUrl: "assets/views/reports/countWarningBySuboffices.html",
    	title: '按分局统计预警数量 ',
    	ncyBreadcrumb: {
    		label: '按分局统计预警数量 '
    	},
    	resolve: loadSequence('select2CssCtrl','select2Ctrl','reportsBySubofficesController','reportsService','datetimepicker')
    })
    
    //根据公司统计报表
    .state('app.reports.countByCompanies', {
    	url: '/countByCompanies',
    	templateUrl: "assets/views/reports/countWarningByCompanies.html",
    	title: '按公司统计预警数量 ',
    	ncyBreadcrumb: {
    		label: '按公司统计预警数量 '
    	},
    	resolve: loadSequence('select2CssCtrl','select2Ctrl','reportsByCompaniesController','reportsService','datetimepicker')
    })
